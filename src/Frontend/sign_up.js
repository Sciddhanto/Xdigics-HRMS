...
const Signup = () => {
    ...
    const handleLoginClick = () => {
        navigate("/login.js"); // Redirect to login.js or an appropriate URL
    };
    ...
    const handleSignupClick = async (e) => {
        ...
        try {
            const response = await api.post("http://localhost:8080/api/auth/signup", {firstname,
                lastname,
                email,
                phoneno,
                password,}
            ...
            if (response.status === 200) {
              ...
              localStorage.setItem("email", email); // Store token for authentication
            ...
            if (err.response) {
              ...
              console.error(err); //error code 400 bad request
            } else {
              // Handle network or unexpected errors
              setError("An unexpected error occurred. Please try again."); 
              console.error(err);  //error code 500 internal server error to be configured later
            }
          }
    };
                    ...
                    <div className="login-container d-flex">
                        ...
                        <div className="login-form p-4">
                            ...
                            <form>
                                ...
                                <div>
                                    <button type="submit" onClick={handleSignupClick} className="btn btn-primary" style={{ float: "left" }}>
                                        Sign up
                                    </button>
